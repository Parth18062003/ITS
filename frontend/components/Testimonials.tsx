  ...
  return (
    <figure
      className={cn(
        ...
        // light styles
        " bg-zinc-200 hover:bg-zinc-950/[.05]",
        // dark styles
        " dark:bg-zinc-50/[.10] dark:hover:bg-zinc-50/[.15]",
      )}
    >
...
export function Testimonials() {
  return (
    <div className="relative flex h-[250px] w-full flex-col items-center justify-center overflow-hidden rounded-lg border bg-zinc-100">
